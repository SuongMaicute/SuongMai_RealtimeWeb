...
connectionhouseGroup.on("suscriptionStatusb", (strGroupJoined, houseName, hasSubscibe) => {
    ...
    if (hasSubscibe) {
        ...
        toastr.success(`You have subscribe successfully. ${houseName}`);
    } else {
        // unsubscribe
        switch (houseName) {
            case 'Slytherin':
        ...
        toastr.success(`You have unsubscribe successfully. ${houseName}`);
